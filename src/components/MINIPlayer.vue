  ...
  <div class="player">
    ...
    <div class="progress" ref="progress">
      ...
      <div class="progress__bar" @click="clickProgress">
        <div class="progress__current" :style="{ width: this.barWidth }"></div>
      </div>
...
export default {
  ...
  computed: {
    duration: function() {
      if (!isNaN(this.audioDuration)) {
        let durmin = Math.floor(this.audioDuration / 60);
        let dursec = Math.floor(this.audioDuration - durmin * 60);
        if (durmin < 10) {
          durmin = "0" + durmin;
        }
        if (dursec < 10) {
    ...
    currentTime: function() {
      let curmin = Math.floor(this.audioCurrentTime / 60);
      let cursec = Math.floor(this.audioCurrentTime - curmin * 60);
      if (curmin < 10) {
        curmin = "0" + curmin;
      }
      if (cursec < 10) {
    ...
    barWidth: function() {
      return (100 / this.audioDuration) * this.audioCurrentTime + "%";
    },
  },
  methods: {
    play() {
  ...
  created() {
    ...
    this.audio.ontimeupdate = function() {
      vm.audioCurrentTime = vm.audio.currentTime;
    };
    this.audio.onloadedmetadata = function() {
      vm.audioDuration = vm.audio.duration;
    };
...
<style lang="scss" scoped src="../css/MINIPlayer.scss"></style>
